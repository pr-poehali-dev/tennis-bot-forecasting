...
export default function Admin() {
  ...
  const updateScore = (id: string, p1Score: number, p2Score: number) => {
    const updated = matches.map(m => {
      if (m.id === id) {
        return { ...m, score: { p1: p1Score, p2: p2Score }, status: 'live' as const };
      }
      return m;
    });
    setMatches(updated);
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Управление матчами</p>
            </div>
          </div>
          <a href="/">
